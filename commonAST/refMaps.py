...
adlDetailMap = dict({"literal": [emptyCntxt],
			...
			"field": [emptyCntxtCpp],
			"floatingliteral": [emptyCntxtCpp],
			"enum": [emptyCntxtCpp],
			"typedef": [emptyCntxtCpp],
			"nontypetemplateparm": [emptyCntxtCpp],
			"cxxunresolvedconstructexpr":[emptyCntxtCpp],
			"stringliteral": [emptyCntxtCpp],
			"cxxfunctionalcastexpr": [emptyCntxtCpp],
			"memberexpr": [emptyCntxtCpp],
			"characterliteral": [emptyCntxtCpp],
			"breakstmt": [emptyCntxtCpp],
			"cxxdeleteexpr": [emptyCntxtCpp],
			"cstylecastexpr": [emptyCntxtCpp],
			...
			"divide":[binOpContext],
			"not":[unOpContext],
			"templatetypeparm":[emptyCntxtCpp],
			"cxxdependentscopememberexpr": [emptyCntxtCpp],
			"cxxthisexpr": [emptyCntxtCpp],
			"unresolvedlookupexpr": [emptyCntxtCpp],
			"nullstmt": [emptyCntxtCpp],
			"parenlistexpr": [emptyCntxtCpp],
