...
module Lichen.Implementation.Lexers.C where
...
import Text.Megaparsec (runParser, many, manyTill, eol, char, anyChar, spaceChar)
...
data Token = Auto | Break | Case | Char | Const | Continue | Default | Do
