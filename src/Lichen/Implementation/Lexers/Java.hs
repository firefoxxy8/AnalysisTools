...
module Lichen.Implementation.Lexers.Java where
...
import Text.Megaparsec (runParser, many, anyChar, spaceChar)
...
data Token = Abstract | Assert | Boolean | Break | Byte | Case | Catch | Char
