...
module Lichen.Implementation.Lexers.Python where
...
import Text.Megaparsec (runParser, many, char, anyChar, spaceChar)
...
data Token = False | None | True | And | As | Assert | Break | Class | Continue
